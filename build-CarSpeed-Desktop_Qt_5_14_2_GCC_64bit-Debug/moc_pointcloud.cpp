/****************************************************************************
** Meta object code from reading C++ file 'pointcloud.h'
**
...
#include <memory>
#include "../CarSpeed/pointcloud.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'pointcloud.h' doesn't include <QObject>."
...
void pointcloud::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<pointcloud *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject pointcloud::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_pointcloud.data,
    qt_meta_data_pointcloud,
    qt_static_metacall,
    nullptr,
    nullptr
} };
